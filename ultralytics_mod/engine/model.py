...
from ultralytics_mod.cfg import TASK2DATA, get_cfg, get_save_dir
from ultralytics_mod.engine.results import Results
from ultralytics_mod.hub import HUB_WEB_ROOT, HUBTrainingSession
from ultralytics_mod.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            model (str | Path): Path or name of the model to load or create. Can be a local file path, a
                model name from ultralytics_mod HUB, or a Triton Server model.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt") -> None:
        ...
        from ultralytics_mod import __version__
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from ultralytics_mod.trackers import register_tracker
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from ultralytics_mod.utils.tuner import run_ray_tune
    ...
    def names(self) -> Dict[int, str]:
        ...
        """
        from ultralytics_mod.nn.autobackend import check_class_names
