...
from ultralytics_mod.utils.metrics import OKS_SIGMA
from ultralytics_mod.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from ultralytics_mod.utils.tal import RotatedTaskAlignedAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        if self.iou_type == "iou":
            ...
            iou = new_bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask], xywh=False, PIouV1=False, PIouV2=True, PIou_Lambda=1.3)
