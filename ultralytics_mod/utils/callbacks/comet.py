...
from ultralytics_mod.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from ultralytics_mod.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def on_fit_epoch_end(trainer) -> None:
    ...
    if curr_epoch == 1:
        from ultralytics_mod.utils.torch_utils import model_info_for_loggers
