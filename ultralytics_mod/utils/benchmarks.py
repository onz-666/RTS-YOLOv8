...
Usage:
    from ultralytics_mod.utils.benchmarks import ProfileModels, benchmark
...
from ultralytics_mod import YOLO, YOLOWorld
from ultralytics_mod.cfg import TASK2DATA, TASK2METRIC
from ultralytics_mod.engine.exporter import export_formats
from ultralytics_mod.utils import ARM64, ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from ultralytics_mod.utils.checks import IS_PYTHON_3_13, check_imgsz, check_requirements, check_yolo, is_rockchip
from ultralytics_mod.utils.downloads import safe_download
from ultralytics_mod.utils.files import file_size
from ultralytics_mod.utils.torch_utils import get_cpu_info, select_device
...
def benchmark(
    ...
    Examples:
        ...
        >>> from ultralytics_mod.utils.benchmarks import benchmark
...
class ProfileModels:
    ...
    Examples:
        ...
        >>> from ultralytics_mod.utils.benchmarks import ProfileModels
