...
from ultralytics_mod.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from ultralytics_mod.utils.checks import check_font, check_version, is_ascii
from ultralytics_mod.utils.files import increment_path
...
class Annotator:
    ...
    Examples:
        >>> from ultralytics_mod.utils.plotting import Annotator
    ...
    def __init__(self, im, line_width=None, font_size=None, font="Arial.ttf", pil=False, example="abc"):
        ...
        if self.pil:  # use PIL
            ...
            try:
                ...
                size = font_size or max(round(sum(self.im.size) / 2 * 0.02), 8) #缩小标签字体
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Examples:
        >>> from ultralytics_mod.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
...
def plot_images(
    ...
    fs = max(fs, 12)  # ensure that the font size is large enough to be easily readable.
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Examples:
        >>> from ultralytics_mod.utils.plotting import plot_results
