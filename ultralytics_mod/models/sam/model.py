...
This module provides an interface to the Segment Anything Model (SAM) from ultralytics_mod, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from ultralytics_mod, designed for
