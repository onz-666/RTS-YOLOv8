...
from ultralytics_mod.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
from ultralytics_mod.data.utils import check_det_dataset
from ultralytics_mod.models.yolo.world import WorldTrainer
from ultralytics_mod.utils import DEFAULT_CFG
from ultralytics_mod.utils.torch_utils import de_parallel
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Examples:
        >>> from ultralytics_mod.models.yolo.world.train_world import WorldTrainerFromScratch
        >>> from ultralytics_mod import YOLOWorld
        >>> data = dict(
        ...     train=dict(
