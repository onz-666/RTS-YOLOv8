...
from ultralytics_mod.nn.tasks import PoseModel
from ultralytics_mod.utils import DEFAULT_CFG, LOGGER
...
class PoseTrainer(yolo.detect.DetectionTrainer):
    ...
    Examples:
        >>> from ultralytics_mod.models.yolo.pose import PoseTrainer
