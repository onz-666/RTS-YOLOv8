...
from ultralytics_mod.hub.auth import Auth
from ultralytics_mod.hub.session import HUBTrainingSession
from ultralytics_mod.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, events
from ultralytics_mod.utils import LOGGER, SETTINGS, checks
...
def check_dataset(path: str, task: str) -> None:
    ...
    Examples:
        >>> from ultralytics_mod.hub import check_dataset
