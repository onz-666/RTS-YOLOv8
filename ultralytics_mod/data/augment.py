...
from ultralytics_mod.data.utils import polygons2masks, polygons2masks_overlap
from ultralytics_mod.utils import LOGGER, colorstr
from ultralytics_mod.utils.checks import check_version
from ultralytics_mod.utils.instance import Instances
from ultralytics_mod.utils.metrics import bbox_ioa
from ultralytics_mod.utils.ops import segment2box, xyxyxyxy2xywhr
from ultralytics_mod.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from ultralytics_mod.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_mod.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_mod.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ultralytics_mod.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            # lut_hue = ((x * (r[0] + 1)) % 180).astype(dtype)   # original hue implementation from ultralytics_mod<=8.3.78
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics_mod.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from ultralytics_mod.data.dataset import YOLODataset
        >>> from ultralytics_mod.utils import IterableSimpleNamespace
