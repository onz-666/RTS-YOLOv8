...
from ultralytics_mod.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
from ultralytics_mod.utils.downloads import download
...
def convert_coco(
    ...
    Examples:
        >>> from ultralytics_mod.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Examples:
        >>> from ultralytics_mod.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Examples:
        >>> from ultralytics_mod.data.converter import convert_dota_to_yolo_obb
    ...
    Notes:
        The input directory structure assumed for dataset:
            ...
            - labels
                ...
                └─ NNN.txt
    """
    from ultralytics_mod import SAM
    from ultralytics_mod.data import YOLODataset
    from ultralytics_mod.utils.ops import xywh2xyxy
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from ultralytics_mod.data.converter import create_synthetic_coco_dataset
